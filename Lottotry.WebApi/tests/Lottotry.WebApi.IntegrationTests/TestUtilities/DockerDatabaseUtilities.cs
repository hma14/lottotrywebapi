...
namespace Lottotry.WebApi.IntegrationTests.TestUtilities
{
    using Docker.DotNet;
    ...
    public static class DockerSqlDatabaseUtilities
    {
        ...
        public const string DB_CONTAINER_NAME = "IntegrationTestingContainer_Lottotry.WebApi";
        public const string DB_VOLUME_NAME = "IntegrationTestingVolume_Lottotry.WebApi";
                ...
                var sqlContainer = await dockerClient
                    ...
                    .CreateContainerAsync(new CreateContainerParameters
                    {
                        ...
                        HostConfig = new HostConfig
                        {
                            ...
                            {
                                $"{DB_VOLUME_NAME}:/Lottotry.WebApi_data"
                            }
                        },
                    });
